export const UNPROCESSABLE_ENTITY_EXCEPTION = {
  ...
  CATEGORY: {
    ...
    DESCRIPTION: {
      IS_NOT_EMPTY: 'CATEGORY.DESCRIPTION.IS_NOT_EMPTY',
    },
  },
  COURSE: {
    NAME: {
  ...
  LESSON: {
    ...
    BODY: {
      ...
      IS_NOT_EMPTY: 'LESSON.BODY.IS_NOT_EMPTY',
    },
    SECTION_ID: {
    ...
    VIDEO_URL: {
      ...
      IS_NOT_BLANK: 'LESSON.VIDEO_URL.IS_NOT_BLANK',
    },
  },
  ASSIGNMENT: {
    NAME: {
  ...
  EXERCISE: {
    ...
    DUE_DATE: {
      IS_NOT_EMPTY: 'EXERCISE.DUE_DATE.IS_NOT_EMPTY',
    },
  },
  QUESTION: {
    TEXT: {
    ...
    OPTIONS: {
      AT_LEAST_TWO_OPTION_IS_REQUIRED: 'QUESTION.OPTIONS.AT_LEAST_TWO_OPTION_IS_REQUIRED',
    },
  },
  QUESTION_OPTION: {
    TEXT: {
      IS_NOT_EMPTY: 'QUESTION_OPTION.TEXT.IS_NOT_EMPTY',
    },
  },
  QUESTION_CATEGORY: {
    NAME: {
  ...
  USER: {
    PASSWORD: {
      IS_NOT_EMPTY: 'USER.PASSWORD.IS_NOT_EMPTY',
      LENGTH_5: 'USER.PASSWORD.LENGTH_5',
    },
    USERNAME: {
      IS_NOT_EMPTY: 'USER.USERNAME.IS_NOT_EMPTY',
      LENGTH_5: 'USER.USERNAME.LENGTH_5',
    },
    PHONE: {
      FORMAT_IS_NOT_VALID: 'USER.PHONE.FORMAT_IS_NOT_VALID',
    },
    EMAIL: {
      FORMAT_IS_NOT_VALID: 'USER.EMAIL.FORMAT_IS_NOT_VALID',
    },
    DISPLAY_NAME: {
      IS_NOT_EMPTY: 'USER.DISPLAY_NAME.IS_NOT_EMPTY',
    },
  },
  COURSE_OUTCOME: {
    NAME: {
      IS_NOT_EMPTY: 'COURSE_OUTCOME.NAME.IS_NOT_EMPTY',
    },
  },
  LESSON_COMMENT: {
    BODY: {
      IS_NOT_EMPTY: 'LESSON_COMMENT.BODY.IS_NOT_EMPTY',
    },
  },
  NOTIFICATION: {
    TITLE: {
      IS_NOT_EMPTY: 'NOTIFICATION.TITLE.IS_NOT_EMPTY',
    },
    CONTENT: {

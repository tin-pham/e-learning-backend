...
const { NAME, SCHEMA } = DATABASE_TABLE.ASSIGNMENT_SUBMIT_NOTIFICATION;
const { NAME: ASSIGNMENT_SUBMIT_NAME, SCHEMA: ASSIGNMENT_SUBMIT_SCHEMA } = DATABASE_TABLE.ASSIGNMENT_SUBMIT;
...
export async function up(database: DatabaseService): Promise<void> {
  await database.schema
    ...
    .addColumn(SCHEMA.ASSIGNMENT_SUBMIT_ID, 'integer', (column) =>
